...
class TestTimerWithCallbacks:
    ...
    def test_timer_callbacks_integration(self):
        ...
        timer = Timer(duration=timedelta(seconds=1), on_start=[on_start_callback], on_end=[on_end_callback])
    ...
    def test_timer_service_with_callbacks(self):
        ...
        timer = service.create_timer("callback_timer", timedelta(seconds=1), on_start=[on_start], on_end=[on_end])
...
class TestNotificationsIntegration:
    ...
    def test_timer_notifications_integration(self, mock_sound, mock_notification):
        ...
        timer = Timer(duration=timedelta(seconds=1), on_end=[track_notification])
...
class TestCompleteUserWorkflow:
    ...
    def test_complete_terminal_workflow(self, mock_playsound):
        ...
        # 2. Create timer
        timer = service.create_timer("workflow_test", duration, on_start=[on_start], on_end=[on_end])
